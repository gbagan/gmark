...
void schem::add_edge(size_t subject_type,  size_t predicate, size_t object_type, char multiplicity, int edgeTypeId,
    ...
    edges.emplace_back(subject_type, predicate, object_type, multiplicity, edgeTypeId, outgoing_dist, incoming_dist);
}
...
void schem::add_edge(size_t subject_type, size_t predicate, size_t object_type, char multiplicity, int edgeTypeId,
    ...
    add_edge(subject_type, predicate, object_type, multiplicity, edgeTypeId, outgoing_dist, incoming_dist);
}
