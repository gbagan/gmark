...
public:
	...
	int maxNumberForSubjectNodes;
	int maxNumberForObjectNodes;
	...
	int addOrUpdateSubjectNodes(config::edge & edgeType, int iterationNumber, int numberOfNodesOfMax, int maxNodesToConnectTo);
	int addOrUpdateObjectNodes(config::edge & edgeType, int iterationNumber, int numberOfNodesOfMax, int maxNodesToConnectTo);
