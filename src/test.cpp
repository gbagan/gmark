...
void creatRankFile(config::config conf, string graphFileName) {
	vector<int> outDistr;
//	vector<int> inDistr;
...
//        string fileName = "outputGraphOld" + to_string(i) + ".txt";
...
//    }
  	...
  	// #### ANALYSIS ####
      analysisIncrDetGraph analyzeGraph("outputGraph1.txt", conf);
