...
//			if (j == 0) {
//				graphGenerator.processEdgeType(conf2, conf2.schema.edges.at(i), outputFile, true);
//			} else {
//				graphGenerator.processEdgeType(conf2, conf2.schema.edges.at(i), outputFile, false);
//			}
//		}
//	}
//	// ##Sequential##
...
//	cout << duration << ", ";
	...
	// #### ANALYSIS ####
    analysisIncrDetGraph analyzeGraph("outputGraph2.txt", conf);
//    analyzeGraph.zipfianPosAnalysis(2, false);
//
//
    ofstream rFile;
    rFile.open("distributionAnalysis2.r", ios::trunc);
